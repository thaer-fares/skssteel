...
Route::name('site.')->group(function () {
    //LOGIN GROUP
    Route::group(['namespace' => 'Site', 'middleware' => ['guest:admin', 'throttle:100,1']], function () {

        //LOGIN ROUTE
        Route::get('welcome', [\App\Http\Controllers\Site\SiteController::class, 'getWelcome'])->name('welcome');
        Route::get('welcome2', [\App\Http\Controllers\Site\SiteController::class, 'getArabicWelcome'])->name('Arabicwelcome');
...
Route::name('admin.')->group(function () {
    ...
    Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['guest:admin', 'throttle:100,1']], function () {
        ...
        //LOGIN ROUTE
        Route::get('login', [\App\Http\Controllers\Admin\LoginController::class, 'getLogin'])->name('login.view');
        Route::post('login', [\App\Http\Controllers\Admin\LoginController::class, 'postLogin'])->name('login.post');
    });

    Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'throttle:100,1']], function () {

        //Dashboard Route
        Route::get('dashboard', [\App\Http\Controllers\Admin\DashboardController::class, 'getIndex'])->name('dashboard.view');
        Route::get('profile', [\App\Http\Controllers\Admin\DashboardController::class, 'getProfile'])->name('dashboard.profile');
        Route::post('profile', [\App\Http\Controllers\Admin\DashboardController::class, 'postProfile'])->name('dashboard.profile.post');
        Route::get('password', [\App\Http\Controllers\Admin\DashboardController::class, 'getPassword'])->name('dashboard.password');
        Route::post('password', [\App\Http\Controllers\Admin\DashboardController::class, 'postPassword'])->name('dashboard.password.post');
       ...
       Route::post('applications/status', [\App\Http\Controllers\Admin\RegistrationApplicationsController::class, 'postStatus'])->name('applications.status');
        ...
        //Logout Route
        Route::get('logout', [\App\Http\Controllers\Admin\DashboardController::class, 'getLogout'])->name('dashboard.logout');
