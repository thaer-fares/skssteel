                ...
                <div class="kt-portlet">
                    ...
                    <form class="kt-form kt-form--label-right">
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <input type="email" class="form-control searchable" name="email" id="email" placeholder="البريد الإلكتروني">
                                </div>
                                <div class="col-lg-6">
                                    <select class="form-control kt-selectpicker searchable" name="status" id="status" data-live-search="true">
